...
The measure of accuracy is the area under the ROC curve and the accuracy of our model is 0.987. Interestingly, the ROC curve suggests the QDA model is the most accuracte despite its test error being larger than that of the logistic or LASSO regressions.
